    ...
    .bulletin
      ...
      .supports
        ...
        .icon
          ...
          &.decrease
            bg-image('../../assets/seller/decrease_4')
          &.discount
            bg-image('../../assets/seller/discount_4')
          &.guarantee
            bg-image('../../assets/seller/guarantee_4')
          &.invoice
            bg-image('../../assets/seller/invoice_4')
          &.special
            bg-image('../../assets/seller/special_4')
        .text
          line-height: 16px
          font-size: 12px
          color: rgb(7,17,27)
